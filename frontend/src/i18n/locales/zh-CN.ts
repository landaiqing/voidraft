export default {
    ...
    settings: {
        ...
        themeColors: {
            ...
            activeLine: '当前行背景色',
            lineNumber: '行号颜色',
            activeLineNumber: '当前行号颜色',
            diffInserted: '差异插入色',
            diffDeleted: '差异删除色',
            diffChanged: '差异变更色',
            borderColor: '边框颜色',
            matchingBracket: '匹配括号颜色',
            searchMatch: '搜索匹配背景色',
            searchMatchSelected: '选中匹配背景色',
            searchMatchSelectedOutline: '选中匹配边框色',
            // 语法高亮 - 注释
            comment: '注释',
            lineComment: '行注释',
            blockComment: '块注释',
            ...
            unit: '单位',
            modifier: '修饰符',
            operatorKeyword: '运算符关键字',
            controlKeyword: '控制关键字',
            definitionKeyword: '定义关键字',
            moduleKeyword: '模块关键字',
            // 语法高亮 - 运算符
            operator: '运算符',
            derefOperator: '解引用运算符',
            arithmeticOperator: '算术运算符',
            logicOperator: '逻辑运算符',
            bitwiseOperator: '位运算符',
            compareOperator: '比较运算符',
            updateOperator: '赋值运算符',
            definitionOperator: '定义运算符',
            typeOperator: '类型运算符',
            controlOperator: '控制运算符',
            // 语法高亮 - 标点
            punctuation: '标点符号',
            separator: '分隔符',
            bracket: '括号',
